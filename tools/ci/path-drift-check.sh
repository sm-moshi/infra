...
ALLOWLIST_RE='^(ansible/?|apps/?|argocd/?|cluster/?|docs/?|terraform/?|tools/?|memory-bank/?|\.gitea/?|\.github/?|\.vscode/?|\.devcontainer/?|\.codex/?|\.contextstream/?|\.editorconfig|\.envrc|\.gitattributes|\.gitignore|\.pre-commit-config\.yaml|\.rumdl\.toml|\.yamllint|\.dcignore|\.kube-linter\.yaml|AGENTS\.md|CODEOWNERS|README\.md|SECURITY\.md|WARP\.md|cliff\.toml|config\.yaml|config\.yaml\.example|mise\.toml|renovate\.json|.sonarlint/?)$'
